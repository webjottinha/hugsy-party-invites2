...
const FORM_URL = "https://docs.google.com/forms/d/e/1FAIpQLSe4NMsd_7DRwzMqb_yWn53u9JVcj5KyOzdTr2eD6hsG3jK5Fw/formResponse";
...
const initialValues: FormValues = { guardian: "", children: "" };
...
export function RsvpForm() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    const body = new URLSearchParams({
      "entry.366340186": values.guardian.trim(),
      "entry.1345212280": values.children.trim(),
    });
